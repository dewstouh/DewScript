...
require('includes.dewscript.data.globals')
require('includes.dewscript.utils.functions')
require('includes.dewscript.utils.samurais_utils')
...
DewMenu:add_imgui(function()
    ImGui.SeparatorText("About")
    UI.wrappedText(
        "DewScript helps you boost your account with such recovery methods, unlocks, stats editor & functions to enchance your game experience!",
        25)
    ImGui.Dummy(1, 10)
    ...
    ImGui.Dummy(1, 10)
    ImGui.Separator()
    ImGui.LabelText("By Dew", "For You")
end)
------------------------------------

phoneAnim = false

local Self = DewMenu:add_tab("Self     ")
...
time = {
{
    ...
    name = "Time Driving Bikes",
    hash = MPX() .. "TIME_DRIVING_BIKE",
    type = "int",
}, {
    name = "Time Driving Helicopters",
    hash = MPX() .. "TIME_DRIVING_HELI",
    type = "int",
}, {
    name = "Time Driving Planes",
    hash = MPX() .. "TIME_DRIVING_PLANE",
    type = "int",
}, {
    name = "Time Driving Boats",
    hash = MPX() .. "TIME_DRIVING_BOAT",
    type = "int",
}, {
    name = "Time Driving Quadbikes",
    hash = MPX() .. "TIME_DRIVING_QUADBIKE",
    type = "int",
}, {
    name = "Time Driving Bicycles",
...
local rp = require('includes.dewscript.data.rp')
...
-- RECOVERY --
local Recovery = DewMenu:add_tab("Recovery")
...
-- HEIST --
local DewMenuS = Recovery:add_tab("Apartment Heist Editor (15 MIL)")
local DewMenuSGuide = DewMenuS:add_tab("---> HOW TO USE | GUIDE")
DewMenuSGuide:add_imgui(function()
...
local DewMoneyLoops = Recovery:add_tab("[RISK] AFK MONEY LOOP")
DewMoneyLoops:add_imgui(function()
...
for _, method in ipairs(loops) do
    local checkbox = DewMoneyLoops:add_checkbox(method.name, function()
    end)
